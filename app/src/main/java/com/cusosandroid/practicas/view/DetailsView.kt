...
// --- ESTRUCTURA DE DATOS PARA LA INFORMACIÓN DE LA DIVISIÓN ---
/**
 * Estructura para la información de la división.
 * @param title El título principal (ej: "LAKERS vs. DIVISIÓN PACÍFICO").
 * @param sections Un mapa donde la clave es el título de la sección y el valor es el contenido.
 */
...
@OptIn(ExperimentalMaterial3Api::class, ExperimentalTextApi::class) // Añadir ExperimentalTextApi para el degradado
@Composable
fun DetailsView(navController: NavHostController, team: String, division: String) {
    ...
    // Obtenemos la información ya estructurada
...
// --- COMPOSABLE AUXILIAR PARA LAS TARJETAS DE SECCIÓN ---
@Composable
fun SectionCard(title: String, content: String, cardColor: Color, textColor: Color) {
    Card(
...
// --- FUNCIÓN getTeamDivisionInfo COMPLETAMENTE REFACTORIZADA Y UNIFICADA ---
fun getTeamDivisionInfo(team: String, division: String): DivisionInfo {
    ...
    return when ("$shortTeamNameForLogic-$division") {
        ...
        "Knicks-Noroeste" -> DivisionInfo(
            ...
            // ... (el resto de tus casos, como "Knicks-Suroeste", se mantienen igual)
